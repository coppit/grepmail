...
my %tests = (
"grepmail -E $single_quote\$email_body =~ /mime/$single_quote t/mailboxes/mailarc-1.txt"
  => ['body_mime','none'],
"grepmail -E $single_quote\$email_header =~ /Handy/$single_quote t/mailboxes/mailarc-1.txt"
  => ['header_handy','none'],
"grepmail -E $single_quote\$email_header =~ /^From.*aarone/$single_quote t/mailboxes/mailarc-1.txt"
  => ['header_aarone','none'],
"grepmail -E $single_quote\$email_header =~ /Handy/ && \$email_body =~ /Handy/$single_quote t/mailboxes/mailarc-1.txt"
  => ['header_body_handy','none'],
"grepmail -E $single_quote\$email_body =~ /Handy/$single_quote t/mailboxes/mailarc-1.txt"
  => ['body_handy','none'],
"grepmail -E $single_quote\$email_header =~ /Handy/$single_quote t/mailboxes/mailarc-1.txt"
  => ['header_handy','none'],
"grepmail -E $single_quote\$email =~ /Handy/$single_quote t/mailboxes/mailarc-1.txt"
  => ['all_handy','none'],
"grepmail -E $single_quote\$email =~ /Handy/ && \$email =~ /imagecraft/i$single_quote t/mailboxes/mailarc-1.txt"
  => ['all_handy_imagecraft','none'],
"grepmail -E $single_quote\$email =~ /Handy/ && \$email_header =~ /Blank/$single_quote t/mailboxes/mailarc-1.txt"
  => ['all_handy_blank','none'],
"grepmail -E $single_quote\$email =~ /Handy/ || \$email =~ /buffer/$single_quote t/mailboxes/mailarc-1.txt"
